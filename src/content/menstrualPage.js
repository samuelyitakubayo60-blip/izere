export const menstrualPage = {
  ...
  rw: {
    ...
    labelStyle: { background: 'rgba(30,145,220,0.12)', borderColor: 'rgba(30,145,220,0.3)', color: 'var(--info)' },
    heroStyle: 'radial-gradient(ellipse at 20% 50%,hsl(200,40%,12%) 0%,transparent 60%),var(--bg-dark)',
    titleAccent: 'Imihango',
    titleRest: "n'ubuzima",
    description:
      "Kumenya ukwezi kwawe ni imbaraga. Menya ukwezi kw'imihango, gukurikirana, isuku, n'igihe ujya kwa muganga.",
    nav: [
      { id: 'what', icon: 'tint', label: "Ukwezi kw'imihango" },
      { id: 'phases', icon: 'sync-alt', label: 'Ibice 4' },
      { id: 'pms', icon: 'comment-dots', label: 'PMS' },
      { id: 'tracking', icon: 'mobile-alt', label: 'Gukurikirana' },
      { id: 'hygiene', icon: 'soap', label: 'Isuku' },
      { id: 'problems', icon: 'stethoscope', label: 'Ubufasha' },
    ],
    remember: "Buri kwezi gutandukanye. Gukurikirana bifasha kumenya ibisanzwe ku mubiri wawe — n'igihe ukeneye muganga.",
    sections: [
      {
        id: 'what',
        icon: 'tint',
        title: "Ukwezi kw'imihango ni iki?",
        intro: "Ukwezi kw'imihango ni igikorwa cy'ukwezi cyitegura umubiri ku nda — ni ibisanzwe.",
        stats: [
          { icon: 'calendar-alt', label: 'Ukwezi gusanzwe', value: 'Iminsi 21–35' },
          { icon: 'tint', label: 'Amaraso amara', value: 'Iminsi 3–7' },
          { icon: 'user', label: 'Imihango ya mbere', value: 'Imyaka 10–15' },
        ],
        info: {
          variant: 'info',
          icon: 'lightbulb',
          ...
          list: [
            ...
            'Imihango itagenda neza bisanzwe mu myaka 1–2 ya mbere',
            'Buri muntu afite ukwezi kwe',
            'Sitiresi cyangwa indwara bishobora guhindura ukwezi',
          ],
        },
      },
      {
        id: 'phases',
        icon: 'sync-alt',
        title: "Ibice 4 by'ukwezi",
        intro: 'Ukwezi kwawe gufite ibice bine bitandukanye.',
        cycleTimeline: [
          { icon: 'tint', days: 'Iminsi 1–5', title: 'Imihango', text: 'Gutwikira. Umubiri uvamo umwanya. Ububabare bushobora kubaho.', color: 'var(--danger)' },
          { icon: 'seedling', days: 'Iminsi 1–13', title: 'Gutegura igi', text: 'Umubiri witegura igi. Imisemburo izamuka.', color: 'var(--primary)' },
          { icon: 'circle', days: '~Umunsi 14', title: 'Gurekura igi', text: 'Igihe gutwita bishoboka cyane.', color: 'var(--accent)' },
          { icon: 'moon', days: 'Iminsi 15–28', title: 'Igihe cya nyuma', text: 'PMS ishobora kubaho. Nta nda → imihango isubira.', color: 'var(--info)' },
        ],
        info: {
          variant: 'accent',
          icon: 'microscope',
          title: 'Ku gurekura igi',
          list: [
            'Benshi barekura igi hagati y\'ukwezi',
            'Igi rimara amasaha 12–24',
            'Intanga ngabo ishobora kubaho iminsi 5',
            'Urashobora gutwita mbere cyangwa nyuma',
          ],
        },
      },
      {
        ...
        icon: 'comment-dots',
        title: 'PMS',
        intro: "Impinduka z'umubiri n'amarangamutima mbere y'imihango zitwa PMS.",
        dualInfo: [
          { variant: 'coral', icon: 'heartbeat', title: "Ibimenyetso by'umubiri", list: ['Ububabare mu nda', "Kubabara kw'amabere", 'Umutwe', 'Umunaniro', 'Ububabare mu mugongo'] },
          { variant: 'accent', icon: 'brain', title: "Ibimenyetso by'amarangamutima", list: ["Guhinduka kw'amarangamutima", 'Gushavura', 'Impungenge', 'Kutaryama neza'] },
        ],
        info: {
          variant: 'success',
          icon: 'dumbbell',
          title: 'Uko wacunga PMS',
          list: ['Imyitozo yoroshye', 'Gukomeza mu nda', "Ibiryo birimo icyuma", 'Kuruhuka no kunywa amazi', "Imiti yo kugabanya ububabare iyo bikenewe"],
        },
      },
      {
        id: 'tracking',
        ...
        intro: 'Gukurikirana bifasha kubona igihe gikurikira no kumenya impinduka.',
        glassGrid: [
          { icon: 'calendar-alt', title: 'Kalendari', text: "Andika umunsi wa mbere w'imihango buri kwezi." },
          { icon: 'mobile-alt', title: 'Porogaramu', text: 'Porogaramu zishobora gufasha gusuzuma igihe gikurikira.' },
        ],
        info: {
          variant: 'primary',
          icon: 'clipboard-list',
          title: 'Ibyo gukurikirana',
          list: ["Itariki imihango itangiriraho", 'Iminsi amaraso amara', "Uburemere bw'amaraso", "Ububabare n'amarangamutima"],
        },
      },
      {
        id: 'hygiene',
        icon: 'soap',
        title: "Isuku mu gihe cy'imihango",
        intro: 'Isuku nziza irinda indwara kandi igutuma wiyumva neza.',
        info: {
          variant: 'success',
          icon: 'hands-wash',
          title: "Inama z'isuku",
          list: ['Hindura ibikoresho buri masaha 4–6', 'Sukura intoki', 'Ambara ipantalo isukuye', 'Sukura umubiri', 'Koresha ibikoresho byiza'],
        },
      },
      {
        id: 'problems',
        ...
        info: {
          ...
          list: ['Ububabare bukubuza imirimo', 'Amaraso menshi cyane', 'Imihango ihita amezi menshi', 'Imihango itagenda neza buri gihe', 'Amaraso hagati y\'imihango'],
        },
      },
    ],
  },
